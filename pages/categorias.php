...
<body>
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a class="breadcrumb-link">Categorias</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="row">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>¿Esta seguro que quiere eliminar la categoria?</p>
                                            </div>
                                ...
                                <div class="modal fade" id="datosCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="table-responsive">
                                    <table id="tabla-categorias" class="table table-hover table-bordered first">
    ...
    <script src="../assets/libs/js/categoria.js"></script>
</body>
